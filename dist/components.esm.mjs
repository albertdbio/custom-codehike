...
function Sidebar({ files, activeFile, setActiveFile, }) {
    ...
    return noFiles ? null : (React.createElement("div", { className: "ch-code-browser-sidebar" },
...
function EditorExpandButton(_a) {
    ...
    return (React.createElement(ExpandButton, Object.assign({}, props, { files: step.files, activeFileName: (_b = step.northPanel) === null || _b === void 0 ? void 0 : _b.active })));
}
function CodeExpandButton(_a) {
    var { step } = _a, props = __rest(_a, ["step"]);
    const file = Object.assign(Object.assign({}, step), { name: "" });
    const activeFileName = "";
    return (React.createElement(ExpandButton, Object.assign({}, props, { files: [file], activeFileName: activeFileName })));
}
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("dialog", { ref: ref, className: "ch-expand-dialog", onClose: () => {
            ...
            expanded ? (React.createElement("div", { className: "ch-expand-dialog-content" },
                React.createElement(CodeBrowser, { files: files, startingFileName: activeFileName }))) : undefined)));
}
...
function CodeTween(_a) {
    ...
    return !dimensions || config.debug ? (React.createElement(BeforeDimensions, { element: element, htmlProps: preProps, debug: config.debug })) : (React.createElement(AfterDimensions, { dimensions: dimensions, stepInfo: stepInfo, config: config, progress: progress, htmlProps: preProps, tween: tween }));
}
...
function AfterDimensions({ config: { minZoom = 1, maxZoom = 1, horizontalCenter = false, }, dimensions, stepInfo, progress, htmlProps, config, tween, }) {
    ...
    return (React.createElement(Wrapper, { htmlProps: htmlProps, measured: true },
        ...
        React.createElement("div", { className: "ch-code-buttons" },
            ...
            config.showExpandButton ? (React.createElement(CodeExpandButton, { className: "ch-code-button", step: tween.prev })) : undefined)));
}
...
function EditorTween(_a) {
    ...
    const northButtons = (React.createElement(React.Fragment, null,
        ...
        showExpandButton ? (React.createElement(EditorExpandButton, { className: "ch-editor-button", step: next || prev })) : undefined));
...
function Code(props) {
    ...
    return (React.createElement(InnerCode, { editorStep: step, onTabClick: onTabClick, globalConfig: globalConfig, codeConfigProps: codeConfigProps }));
}
function InnerCode({ onTabClick, globalConfig, editorStep, codeConfigProps, }) {
    ...
    if (!editorStep.southPanel &&
        ...
        return (React.createElement("div", { className: `ch-codeblock not-prose ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style },
            React.createElement(CodeSpring, { className: "ch-code", config: config, step: editorStep.files[0] })));
    }
    else {
        const frameProps = {
        ...
        return (React.createElement("div", { className: `ch-codegroup not-prose ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style },
            React.createElement(EditorSpring, Object.assign({}, editorStep, { frameProps: frameProps, codeConfig: config }))));
    }
}
...
function Section(_a) {
    ...
    const [state, setState] = React.useState(editorStep);
...
function SectionCode(_a) {
    ...
    return (React.createElement(InnerCode, { editorStep: section.editorStep, globalConfig: globalConfig, codeConfigProps: Object.assign(Object.assign({}, section.codeConfigProps), codeConfigProps), onTabClick: onTabClick }));
}
// ---
...
function Preview(_a) {
    ...
    return (React.createElement("div", { className: "ch-preview" + (className ? " " + className : ""), style: style, "data-ch-theme": globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.themeName }, frameless ? (kids) : (React.createElement(MiniBrowser, Object.assign({ loadUrl: show }, rest, { children: kids })))));
}
...
function Spotlight(_a) {
    ...
    return (React.createElement("section", { className: `ch-spotlight ${withPreview ? "ch-spotlight-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig.themeName },
        ...
        React.createElement("div", { className: "ch-spotlight-sticker" },
            React.createElement(InnerCode, { editorStep: tab, globalConfig: globalConfig, codeConfigProps: codeConfigProps, onTabClick: onTabClick }),
            presetConfig ? (React.createElement(Preview, { className: "ch-spotlight-preview", files: tab.files, presetConfig: presetConfig, globalConfig: globalConfig })) : hasPreviewSteps ? (React.createElement(Preview, Object.assign({ className: "ch-spotlight-preview" }, previewChildren[state.stepIndex]["props"], { globalConfig: globalConfig }))) : null)));
}
...
function StaticToggle({ viewDynamicText = "View dynamic version", viewStaticText = "View static version", }) {
    ...
    return (React.createElement("button", { onClick: toggleStatic, className: "ch-static-toggle", "data-ch-static": forceStatic }, forceStatic ? viewDynamicText : viewStaticText));
}
...
function Swap({ query, staticElement, children }) {
    ...
    return isServer ? (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: `${mainClassName} ssmq-static` }, staticElement),
        React.createElement("div", { className: `${mainClassName} ssmq-dynamic` }, dynamicElement),
        React.createElement("script", { className: mainClassName, dangerouslySetInnerHTML: {
                __html: getScript(query, mainClassName),
            } }))) : (React.createElement(React.Fragment, null,
        React.createElement("div", null, showStatic ? staticElement : dynamicElement)));
}
...
function CodeSlot(localProps) {
    ...
    return (React.createElement(InnerCode, { globalConfig: globalConfig, editorStep: editorStep, codeConfigProps: Object.assign(Object.assign({}, codeConfigProps), localProps), onTabClick: onTabClick }));
}
function PreviewSlot(localProps) {
    ...
    return (React.createElement(Preview, Object.assign({ className: "ch-scrollycoding-preview", files: editorStep.files, globalConfig: globalConfig, presetConfig: presetConfig }, previewStep["props"])));
}
...
function Scrollycoding(props) {
    ...
    return (React.createElement(Swap, { query: staticMediaQuery, staticElement: React.createElement(StaticScrollycoding, Object.assign({}, props)) },
        React.createElement(DynamicScrollycoding, Object.assign({}, props))));
}
function StaticScrollycoding(_a) {
    ...
    const { stepsChildren, previewChildren } = extractPreviewSteps(children, hasPreviewSteps);
    return (React.createElement("section", { className: `ch-scrollycoding-static ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style }, stepsChildren.map((children, i) => (React.createElement(StaticSection, { key: i, editorStep: editorSteps[i], previewStep: previewChildren && previewChildren[i], presetConfig: presetConfig, codeConfigProps: codeConfigProps, globalConfig: globalConfig }, children)))));
}
function StaticSection({ editorStep, previewStep, children, presetConfig, codeConfigProps, globalConfig, }) {
    ...
    return (React.createElement(StaticStepContext.Provider, { value: Object.assign(Object.assign({}, step), { setFocus,
            globalConfig }) },
        React.createElement(LinkableSection, { onActivation: setFocus, onReset: resetFocus }, children)));
}
function DynamicScrollycoding(_a) {
    ...
    return (React.createElement("section", { className: `ch-scrollycoding ${withPreview ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.themeName },
        React.createElement("div", { className: "ch-scrollycoding-content" },
            React.createElement(Scroller, { onStepChange: onStepChange, triggerPosition: globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.triggerPosition }, stepsChildren.map((children, i) => (React.createElement(Step, { as: "div", key: i, index: i, onClick: () => onStepChange(i), className: "ch-scrollycoding-step-content", "data-selected": i === state.stepIndex ? "true" : undefined },
        ...
        React.createElement("div", { className: "ch-scrollycoding-sticker" },
            React.createElement(InnerCode, { editorStep: tab, globalConfig: globalConfig, onTabClick: onTabClick, codeConfigProps: Object.assign(Object.assign({ showExpandButton: true }, codeConfigProps), { rows: undefined }) }),
            presetConfig ? (React.createElement(Preview, { className: "ch-scrollycoding-preview", files: tab.files, globalConfig: globalConfig, presetConfig: presetConfig })) : hasPreviewSteps ? (React.createElement(Preview, Object.assign({ className: "ch-scrollycoding-preview" }, previewChildren[state.stepIndex]["props"], { globalConfig: globalConfig }))) : null)));
}

function Slideshow(props) {
    return React.createElement(InnerSlideshow, Object.assign({}, props));
}
function InnerSlideshow(_a) {
    ...
    return (React.createElement("div", { className: `ch-slideshow ${withPreview ? "ch-slideshow-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig.themeName },
        React.createElement("div", { className: "ch-slideshow-slide" },
            React.createElement(InnerCode, { globalConfig: globalConfig, editorStep: tab, codeConfigProps: codeConfigProps, onTabClick: onTabClick }),
            presetConfig ? (React.createElement(Preview, { className: "ch-slideshow-preview", files: tab.files, presetConfig: presetConfig, globalConfig: globalConfig })) : hasPreviewSteps ? (React.createElement(Preview, Object.assign({ className: "ch-slideshow-preview" }, previewChildren[currentIndex]["props"], { globalConfig: globalConfig }))) : null),
...
function InlineCode(_a) {
    ...
    return (React.createElement("span", Object.assign({ "data-ch-theme": globalConfig.themeName, className: "ch-inline-code not-prose" +
