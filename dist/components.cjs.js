...
function Sidebar({ files, activeFile, setActiveFile, }) {
    ...
    return noFiles ? null : (React__default["default"].createElement("div", { className: "ch-code-browser-sidebar" },
...
function EditorExpandButton(_a) {
    var _b;
    var { step } = _a, props = __rest(_a, ["step"]);
    step.files;
    step.northPanel.active;
    return (React__default["default"].createElement(ExpandButton, Object.assign({}, props, { files: step.files, activeFileName: (_b = step.northPanel) === null || _b === void 0 ? void 0 : _b.active })));
}
function CodeExpandButton(_a) {
    var { step } = _a, props = __rest(_a, ["step"]);
    const file = Object.assign(Object.assign({}, step), { name: "" });
    const activeFileName = "";
    return (React__default["default"].createElement(ExpandButton, Object.assign({}, props, { files: [file], activeFileName: activeFileName })));
}
function ExpandButton({ style, className, files, activeFileName, }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement("dialog", { ref: ref, className: "ch-expand-dialog", onClose: () => {
            ...
            expanded ? (React__default["default"].createElement("div", { className: "ch-expand-dialog-content" },
                React__default["default"].createElement(CodeBrowser, { files: files, startingFileName: activeFileName }))) : undefined)));
}
...
function CodeTween(_a) {
    ...
    return !dimensions || config.debug ? (React__default["default"].createElement(BeforeDimensions, { element: element, htmlProps: preProps, debug: config.debug })) : (React__default["default"].createElement(AfterDimensions, { dimensions: dimensions, stepInfo: stepInfo, config: config, progress: progress, htmlProps: preProps, tween: tween }));
}
...
function AfterDimensions({ config: { minZoom = 1, maxZoom = 1, horizontalCenter = false, }, dimensions, stepInfo, progress, htmlProps, config, tween, }) {
    var _a;
    return (React__default["default"].createElement(Wrapper, { htmlProps: htmlProps, measured: true },
        ...
        React__default["default"].createElement("div", { className: "ch-code-buttons" },
            ...
            config.showExpandButton ? (React__default["default"].createElement(CodeExpandButton, { className: "ch-code-button", step: tween.prev })) : undefined)));
}
...
function EditorTween(_a) {
    ...
    const northButtons = (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        showExpandButton ? (React__default["default"].createElement(EditorExpandButton, { className: "ch-editor-button", step: next || prev })) : undefined));
...
function Code(props) {
    const { editorStep, globalConfig } = props, codeConfigProps = __rest(props, ["editorStep", "globalConfig"]);
    const [step, setStep] = React__default["default"].useState(editorStep);
    function onTabClick(filename) {
        const newStep = updateEditorStep(props.editorStep, filename, null);
        setStep(Object.assign(Object.assign({}, step), newStep));
    }
    return (React__default["default"].createElement(InnerCode, { editorStep: step, onTabClick: onTabClick, globalConfig: globalConfig, codeConfigProps: codeConfigProps }));
}
function InnerCode({ onTabClick, globalConfig, editorStep, codeConfigProps, }) {
    const _a = mergeCodeConfig(globalConfig, codeConfigProps), { className, style } = _a, config = __rest(_a, ["className", "style"]);
    if (!editorStep.southPanel &&
        editorStep.files.length === 1 &&
        !editorStep.files[0].name) {
        return (React__default["default"].createElement("div", { className: `ch-codeblock not-prose ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style },
            React__default["default"].createElement(CodeSpring, { className: "ch-code", config: config, step: editorStep.files[0] })));
    }
    else {
        const frameProps = {
        ...
        return (React__default["default"].createElement("div", { className: `ch-codegroup not-prose ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style },
            React__default["default"].createElement(EditorSpring, Object.assign({}, editorStep, { frameProps: frameProps, codeConfig: config }))));
    }
}
function mergeCodeConfig(globalConfig, local) {
    var _a, _b, _c, _d, _e;
    const // keep the rest
    global = __rest(globalConfig, ["staticMediaQuery", "themeName", "triggerPosition"]);
    return Object.assign(Object.assign(Object.assign({}, global), local), { lineNumbers: (_a = local.lineNumbers) !== null && _a !== void 0 ? _a : global.lineNumbers, maxZoom: (_b = local.maxZoom) !== null && _b !== void 0 ? _b : global.maxZoom, minZoom: (_c = local.minZoom) !== null && _c !== void 0 ? _c : global.minZoom, horizontalCenter: (_d = local.horizontalCenter) !== null && _d !== void 0 ? _d : global.horizontalCenter, showCopyButton: (_e = local.showCopyButton) !== null && _e !== void 0 ? _e : global.showCopyButton });
}
...
function Section(_a) {
    var { children, className, style, editorStep } = _a, codeConfigProps = __rest(_a, ["children", "className", "style", "editorStep"]);
    const [state, setState] = React__default["default"].useState(editorStep);
...
function SectionCode(_a) {
    var { globalConfig } = _a, codeConfigProps = __rest(_a, ["globalConfig"]);
    const section = React__default["default"].useContext(SectionContext);
    ...
    return (React__default["default"].createElement(InnerCode, { editorStep: section.editorStep, globalConfig: globalConfig, codeConfigProps: Object.assign(Object.assign({}, section.codeConfigProps), codeConfigProps), onTabClick: onTabClick }));
}
// ---
...
function Preview(_a) {
    var { globalConfig, files, presetConfig, show, children, frameless, className, style } = _a, rest = __rest(_a, ["globalConfig", "files", "presetConfig", "show", "children", "frameless", "className", "style"]);
    ...
    return (React__default["default"].createElement("div", { className: "ch-preview" + (className ? " " + className : ""), style: style, "data-ch-theme": globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.themeName }, frameless ? (kids) : (React__default["default"].createElement(MiniBrowser, Object.assign({ loadUrl: show }, rest, { children: kids })))));
}
...
function Spotlight(_a) {
    var _b;
    var { children, editorSteps, globalConfig, start = 0, presetConfig, className, style, hasPreviewSteps } = _a, codeConfigProps = __rest(_a, ["children", "editorSteps", "globalConfig", "start", "presetConfig", "className", "style", "hasPreviewSteps"]);
    ...
    return (React__default["default"].createElement("section", { className: `ch-spotlight ${withPreview ? "ch-spotlight-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig.themeName },
        ...
        React__default["default"].createElement("div", { className: "ch-spotlight-sticker" },
            React__default["default"].createElement(InnerCode, { editorStep: tab, globalConfig: globalConfig, codeConfigProps: codeConfigProps, onTabClick: onTabClick }),
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-spotlight-preview", files: tab.files, presetConfig: presetConfig, globalConfig: globalConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-spotlight-preview" }, previewChildren[state.stepIndex]["props"], { globalConfig: globalConfig }))) : null)));
}
...
function toggleStatic() {
    localStorage.setItem("ch-prefers-static", localStorage.getItem("ch-prefers-static") === "true"
        ? "false"
        : "true");
...
function StaticToggle({ viewDynamicText = "View dynamic version", viewStaticText = "View static version", }) {
    const [forceStatic, toggleStatic] = useStaticToggle();
    return (React__default["default"].createElement("button", { onClick: toggleStatic, className: "ch-static-toggle", "data-ch-static": forceStatic }, forceStatic ? viewDynamicText : viewStaticText));
}
function useStaticToggle() {
    const { showStatic: forceStatic } = useMedia("screen and (max-width: 0px)");
    const [firstRender, setFirstRender] = React__default["default"].useState(true);
    React__default["default"].useLayoutEffect(() => {
        if (forceStatic) {
 ...
 */
function Swap({ query, staticElement, children }) {
    ...
    return isServer ? (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement("div", { className: `${mainClassName} ssmq-static` }, staticElement),
        React__default["default"].createElement("div", { className: `${mainClassName} ssmq-dynamic` }, dynamicElement),
        ...
        React__default["default"].createElement("div", null, showStatic ? staticElement : dynamicElement)));
}
...
function CodeSlot(localProps) {
    const context = React__default["default"].useContext(StaticStepContext);
    if (!context) {
        return null;
    }
    const { editorStep, codeConfigProps, setFocus, globalConfig, } = context;
    const onTabClick = (filename) => {
        setFocus({ fileName: filename, focus: null, id: "" });
    };
    return (React__default["default"].createElement(InnerCode, { globalConfig: globalConfig, editorStep: editorStep, codeConfigProps: Object.assign(Object.assign({}, codeConfigProps), localProps), onTabClick: onTabClick }));
}
function PreviewSlot(localProps) {
    const context = React__default["default"].useContext(StaticStepContext);
    if (!context) {
        return null;
    }
    const { editorStep, previewStep, presetConfig, globalConfig, } = context;
    return (React__default["default"].createElement(Preview, Object.assign({ className: "ch-scrollycoding-preview", files: editorStep.files, globalConfig: globalConfig, presetConfig: presetConfig }, previewStep["props"])));
}
const StaticStepContext = React__default["default"].createContext(null);

function Scrollycoding(props) {
    var _a;
    const staticMediaQuery = (_a = props.staticMediaQuery) !== null && _a !== void 0 ? _a : props.globalConfig.staticMediaQuery;
    return (React__default["default"].createElement(Swap, { query: staticMediaQuery, staticElement: React__default["default"].createElement(StaticScrollycoding, Object.assign({}, props)) },
        React__default["default"].createElement(DynamicScrollycoding, Object.assign({}, props))));
}
function StaticScrollycoding(_a) {
    var { globalConfig, 
    // data
    children, editorSteps, presetConfig, hasPreviewSteps, 
    // local config
    staticMediaQuery, start = 0, 
    // element props:
    className, style } = _a, 
    // code config props
    codeConfigProps = __rest(_a, ["globalConfig", "children", "editorSteps", "presetConfig", "hasPreviewSteps", "staticMediaQuery", "start", "className", "style"]);
    const { stepsChildren, previewChildren } = extractPreviewSteps(children, hasPreviewSteps);
    return (React__default["default"].createElement("section", { className: `ch-scrollycoding-static ${className || ""}`, "data-ch-theme": globalConfig.themeName, style: style }, stepsChildren.map((children, i) => (React__default["default"].createElement(StaticSection, { key: i, editorStep: editorSteps[i], previewStep: previewChildren && previewChildren[i], presetConfig: presetConfig, codeConfigProps: codeConfigProps, globalConfig: globalConfig }, children)))));
}
function StaticSection({ editorStep, previewStep, children, presetConfig, codeConfigProps, globalConfig, }) {
    const [step, setStep] = React__default["default"].useState({
        editorStep,
        previewStep,
        presetConfig,
        codeConfigProps,
    ...
    const setFocus = ({ fileName, focus, id, }) => {
        const newEditorStep = updateEditorStep(step.editorStep, fileName, focus);
        setStep(Object.assign(Object.assign({}, step), { editorStep: newEditorStep, selectedId: id }));
    };
    return (React__default["default"].createElement(StaticStepContext.Provider, { value: Object.assign(Object.assign({}, step), { setFocus,
            globalConfig }) },
        React__default["default"].createElement(LinkableSection, { onActivation: setFocus, onReset: resetFocus }, children)));
}
function DynamicScrollycoding(_a) {
    ...
    return (React__default["default"].createElement("section", { className: `ch-scrollycoding ${withPreview ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.themeName },
        React__default["default"].createElement("div", { className: "ch-scrollycoding-content" },
            React__default["default"].createElement(Scroller, { onStepChange: onStepChange, triggerPosition: globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.triggerPosition }, stepsChildren.map((children, i) => (React__default["default"].createElement(Step, { as: "div", key: i, index: i, onClick: () => onStepChange(i), className: "ch-scrollycoding-step-content", "data-selected": i === state.stepIndex ? "true" : undefined },
        ...
        React__default["default"].createElement("div", { className: "ch-scrollycoding-sticker" },
            React__default["default"].createElement(InnerCode, { editorStep: tab, globalConfig: globalConfig, onTabClick: onTabClick, codeConfigProps: Object.assign(Object.assign({ showExpandButton: true }, codeConfigProps), { rows: undefined }) }),
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-scrollycoding-preview", files: tab.files, globalConfig: globalConfig, presetConfig: presetConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-scrollycoding-preview" }, previewChildren[state.stepIndex]["props"], { globalConfig: globalConfig }))) : null)));
}

function Slideshow(props) {
    return React__default["default"].createElement(InnerSlideshow, Object.assign({}, props));
}
function InnerSlideshow(_a) {
    var { globalConfig, 
    // data
    children, editorSteps, hasPreviewSteps, presetConfig, 
    // local config:
    autoFocus, autoPlay, 
    // Set the initial slide index
    start = 0, 
    // Called when the slideshow state changes and returns the current state object
    onChange: onSlideshowChange = () => { }, loop = false, 
    // element props:
    className, style } = _a, 
    // code config props:
    codeConfigProps = __rest(_a, ["globalConfig", "children", "editorSteps", "hasPreviewSteps", "presetConfig", "autoFocus", "autoPlay", "start", "onChange", "loop", "className", "style"]);
    const { stepsChildren, previewChildren } = extractPreviewSteps(children, hasPreviewSteps);
    const withPreview = presetConfig || hasPreviewSteps;
    ...
    return (React__default["default"].createElement("div", { className: `ch-slideshow ${withPreview ? "ch-slideshow-with-preview" : ""} ${className || ""}`, style: style, "data-ch-theme": globalConfig.themeName },
        React__default["default"].createElement("div", { className: "ch-slideshow-slide" },
            React__default["default"].createElement(InnerCode, { globalConfig: globalConfig, editorStep: tab, codeConfigProps: codeConfigProps, onTabClick: onTabClick }),
            presetConfig ? (React__default["default"].createElement(Preview, { className: "ch-slideshow-preview", files: tab.files, presetConfig: presetConfig, globalConfig: globalConfig })) : hasPreviewSteps ? (React__default["default"].createElement(Preview, Object.assign({ className: "ch-slideshow-preview" }, previewChildren[currentIndex]["props"], { globalConfig: globalConfig }))) : null),
...
function InlineCode(_a) {
    var { className, globalConfig, children, code } = _a, rest = __rest(_a, ["className", "globalConfig", "children", "code"]);
    const { lines } = code;
    const allTokens = lines.flatMap(line => line.tokens);
    return (React__default["default"].createElement("span", Object.assign({ "data-ch-theme": globalConfig.themeName, className: "ch-inline-code not-prose" +
...
exports.StaticToggle = StaticToggle;
exports.annotations = annotationsMap;
exports.internal = internal;
exports.useStaticToggle = useStaticToggle;
