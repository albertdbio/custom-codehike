...
function extractLighterAnnotations(codeWithAnnotations, lang, annotationNames) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield lighter.extractAnnotations(codeWithAnnotations, warnIfUnknownLang(lang), annotationNames);
    });
}
...
function warnIfUnknownLang(lang) {
    if (!lighter.LANG_NAMES.includes(lang)) {
...
function highlight({ code, lang, theme, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const r = yield lighter.highlight(code, warnIfUnknownLang(lang), theme);
